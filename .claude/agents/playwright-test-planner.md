...
0. Read `CLAUDE.md`, the story/acceptance criteria, current seed, role matrix and quality risks. Use only local URLs and synthetic data. Planning cannot approve a release or change code.
