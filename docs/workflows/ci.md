...
Los nombres de escenarios de datos viajan en `QA_SEED`; la reproducción numérica de fast-check usa `FC_SEED`. Los PRs de Dependabot tienen token de sólo lectura, por lo que su summary se renderiza y publica como artifact sin intentar comentar.
