...
| Actual + diff             | Cuando un golden falla     | Ver qué píxeles cambiaron                          | `test-results/` y artifact del PR     |
| Screenshot de fallo       | Cuando cualquier E2E falla | Contexto visual inmediato                          | `test-results/`                       |
| Video Playwright          | Cuando cualquier E2E falla | Reconstruir la secuencia de interacción            | `test-results/`                       |
| Trace Playwright          | Cuando cualquier E2E falla | DOM, red, consola, acciones y snapshots temporales | `test-results/`                       |
